...
class ErpQuarterCancelApplicationModel(Base):
    __tablename__ = "quarter_cancel_application"
    __table_args__ = (
        UniqueConstraint(
            'emp_cd', 'div_cd', 'comp_cd', 'quarter_cancel_cd',
            name='employee_quarter_cancel_application_unique_constraint'
        ),
        ForeignKeyConstraint(
        ...
        ForeignKeyConstraint(
         ...
         ForeignKeyConstraint(
            ['comp_cd', 'div_cd', 'emp_cd'],
            ['erp_quartering.quarter_application.comp_cd', 'erp_quartering.quarter_application.div_cd', 'erp_quartering.quarter_application.emp_cd'],
            use_alter=True
        ),
    ...
    quarter_app_cd = Column('quarter_app_cd', Integer)
    quarter_cancel_cd = Column('quarter_cancel_cd', Integer, primary_key=True, index=True)
    cancel_reason = Column('cancel_reason', Text, nullable=True)
    cancel_remark = Column('cancel_remark', Text, nullable=True)

...
class ErpUnderMaintenanceModel(Base):
    __tablename__ = "quarter_under_maintenance"
    __table_args__ = (
        UniqueConstraint(
            'emp_cd', 'div_cd', 'comp_cd', 'under_maintenance_cd',
    ...
    under_maintenance_cd = Column('under_maintenance_cd', Integer, primary_key=True, index=True)

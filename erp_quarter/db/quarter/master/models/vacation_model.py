...
class ErpVacationModel(Base):
    __tablename__ = "quarter_vacation"
    __table_args__ = (
        UniqueConstraint(
            'emp_cd', 'div_cd', 'comp_cd', 'vacation_cd',
            name='employee_quarter_vacation_unique_constraint'
        ),
        ForeignKeyConstraint(
        ...
        ForeignKeyConstraint(
            ['comp_cd', 'div_cd', 'emp_cd', 'under_vacation_cd'],
            ['erp_admin.quarter_under_vacation.comp_cd',
              'erp_admin.quarter_under_vacation.div_cd', 
              'erp_admin.quarter_under_vacation.emp_cd',
              'erp_admin.quarter_under_vacation.under_vacation_cd'],
            use_alter=True
        ),
    ...
    under_vacation_cd = Column('under_vacation_cd', Integer)
    vacation_cd = Column('vacation_cd', Integer, primary_key=True, index=True)
    vacation_vide = Column('vacation_vide', Text)
    vacation_date = Column('vacation_date', Date)
